...
class StockHoldingService:
    def get_stock_holding(self, type, id):        
        self.type = type
        self.id = id
        ...
        with DatabaseConnect() as cursor:
            if self.type == 'USER':
                sql_select_query = """select a.user_id, b.account_id, b.stock_symbol, b.holding_qty, b.purchase_price from user_account a, stock_holding b where a.account_id = b.account_id and a.user_id = %s"""
                
            if self.type == 'ACCOUNT':
                sql_select_query = """select a.user_id, b.account_id, b.stock_symbol, b.holding_qty, b.purchase_price from user_account a, stock_holding b where a.account_id = b.account_id and a.account_id = %s"""
            ...
            for each_record in data_rows:
                ...
                stock_holding_object.stock_symbol = each_record[3]                
